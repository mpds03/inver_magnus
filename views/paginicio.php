...
<body>
    <div id="cajamadre">
        ...
        <div class="col-md-5 p-1">
            ...
            <div class="row">
              <div class="" id="bati">
                ...
                <button type="submit" class="btn btn-light text-danger my-5 " >Licuadoras</button>
        ...
        <div id="regis" class="col-md-4 p-1">
           <a href="ejem.html"><button type="submit"class="btn btn-light " >Iniciar sesion</button></a>

            <a href="ejem.html"><button type="submit" class="btn btn-light ms-1 text-danger">Registrarse</button></a>
        </div>
        <div class="topro">
            <p>TOP 3 PRODUCTOS</p>
        </div>
        ...
        <div>
            <img id="licu" src="/images/licuadora.png" alt="">
            <img id="batimano" src="/images/batidoradem.png" alt="">
            <img id="plancha" src="/images/plancha.png" alt="">
        </div>
    </div>
<!-- //CARDS// -->
    <div class="row row-cols-1 row-cols-md-5 g-4 mx-5 mt-3">
        <div class="col">
          <div class="card h-100 text-center">
            <img src="/images/batidoradem.png" class="card-img-top estructura" alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card h-100 text-center">
            <img src="/images/licuadora.png" class="card-img-top estructura" alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card h-100 text-center">
            <img src="/images/plancha.png" class="card-img-top estructura"  alt="...">
            <div class="card-body">
        ...
        <div class="col">
          <div class="card h-100 text-center">
            <img src="/images/secadora.png" class="card-img-top estructura" alt="...">
            <div class="card-body">
